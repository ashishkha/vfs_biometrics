...
public class PreviewActivity extends AppCompatActivity {
    ...
    private TextView txtViewPassportName,txtViewPassportSurName,txtViewSex,txtViewDOB,txtViewDocumentType,txtViewDocumentNumber,txtViewDateOfExpiry
            ,txtViewNationality,txtViewPersonalNumber;
    private TextView btnSubmit,txtViewApplicationId;
